...
namespace FFCommon {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class TokenDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public TokenRow AddTokenRow(SubscriberRow parentSubscriberRowByFK_Subscriber_Token, System.DateTime PublishedDate, string Body, bool Used) {
        ...
        public partial class TokenRow : global::System.Data.DataRow {
            ...
            public bool Used {
                get {
                    return ((bool)(this[this.tableToken.UsedColumn]));
                }
                set {
                    this[this.tableToken.UsedColumn] = value;
                }
            }
...
SELECT Id, SubscriberId, DeviceToken, Failed, UnreadRelease FROM APNs WHERE (Id = @Id)";
    ...
    public partial class TokenTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Token] WHERE (([Id] = @Original_Id) AND ([SubscriberId] = @Original_" +
                "SubscriberId) AND ([PublishedDate] = @Original_PublishedDate) AND ([Body] = @Ori" +
                "ginal_Body) AND ([Used] = @Original_Used))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_SubscriberId", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubscriberId", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Token] ([SubscriberId], [PublishedDate], [Body], [Used]) VALUES (@Su" +
                "bscriberId, @PublishedDate, @Body, @Used);\r\nSELECT Id, SubscriberId, PublishedDa" +
                "te, Body, Used FROM Token WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@SubscriberId", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubscriberId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Token] SET [SubscriberId] = @SubscriberId, [PublishedDate] = @PublishedDate, [Body] = @Body, [Used] = @Used WHERE (([Id] = @Original_Id) AND ([SubscriberId] = @Original_SubscriberId) AND ([PublishedDate] = @Original_PublishedDate) AND ([Body] = @Original_Body) AND ([Used] = @Original_Used));
SELECT Id, SubscriberId, PublishedDate, Body, Used FROM Token WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@SubscriberId", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "SubscriberId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT            Id, SubscriberId, PublishedDate, Body, Used\r\nFROM              " +
                "Token";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Body, Id, PublishedDate, SubscriberId, Used FROM Token WHERE (Body = @Body" +
                ")";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Body, Id, PublishedDate, SubscriberId, Used FROM Token WHERE (SubscriberId" +
                " = @SubscriberId) ORDER BY PublishedDate";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@SubscriberId", global::System.Data.SqlDbType.BigInt, 8, global::System.Data.ParameterDirection.Input, 0, 0, "SubscriberId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(long Original_Id, long Original_SubscriberId, System.DateTime Original_PublishedDate, string Original_Body, bool Original_Used) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((long)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((long)(Original_SubscriberId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(long SubscriberId, System.DateTime PublishedDate, string Body, bool Used) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((long)(SubscriberId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(long SubscriberId, System.DateTime PublishedDate, string Body, bool Used, long Original_Id, long Original_SubscriberId, System.DateTime Original_PublishedDate, string Original_Body, bool Original_Used, long Id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((long)(SubscriberId));
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((long)(Original_Id));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((long)(Original_SubscriberId));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.DateTime)(Original_PublishedDate));
            if ((Original_Body == null)) {
                throw new global::System.ArgumentNullException("Original_Body");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(long SubscriberId, System.DateTime PublishedDate, string Body, bool Used, long Original_Id, long Original_SubscriberId, System.DateTime Original_PublishedDate, string Original_Body, bool Original_Used) {
            return this.Update(SubscriberId, PublishedDate, Body, Used, Original_Id, Original_SubscriberId, Original_PublishedDate, Original_Body, Original_Used, Original_Id);
        }
    }
